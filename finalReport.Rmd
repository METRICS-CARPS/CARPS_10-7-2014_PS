...
aov_summary_control <- summary(aov(bias ~ story, data=subset(caregiving_salience,
                                                             tnaythreat=='control')))
aov_summary_contrast <- summary(lm(bias~story*tnaythreat, data=caregiving_salience))
...
reportObject <- reproCheck(reportedValue=".027",
                           obtainedValue=aov_summary_contrast$coefficients[[14]],
                           valueType="p")
